...
2. Repeat first name and immediately verify spelling using phonetic alphabet. YOU MUST ALWAYS VERIFY FIRST NAME SPELLING AT THIS STEP EVEN IF THE USERS FIRST NAME WAS PREVIOUSLY CAPTURED. DO NOT ASK FOR THE LAST NAME UNTIL YOU HAVE VERIFIED THE FIRST NAME SPELLING. Ex: "So I have your first name as John spelled J as in Juliet, O as in Oscar, H as in Hotel, N as in November. Is that correct?".
