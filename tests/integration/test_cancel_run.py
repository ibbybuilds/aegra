...
from agent_server.api.runs import active_runs
from agent_server.services.broker import RunBroker, broker_manager
from agent_server.services.streaming_service import streaming_service
...
class TestCancelRun:
    ...
    async def test_cancel_background_task_returns_false_for_missing_task(
        self, run_id: str
    ):
    ...
    async def test_cancel_background_task_returns_false_for_completed_task(
        self, run_id: str
    ):
    ...
    async def test_cancel_background_task_returns_true_for_running_task(
        self, run_id: str
    ):
