...
from src.agent_server.core.auth_handlers import build_auth_context, handle_event
...
"""
    ...
    @pytest.mark.asyncio
    async def test_thread_search_returns_filters(
        self, aegra_config_with_auth_handlers, mock_auth_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_assistant_delete_denied(
        self, aegra_config_with_auth_handlers, mock_auth_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_assistant_create_allowed_with_metadata(
        self, aegra_config_with_auth_handlers, mock_auth_file
    ):
