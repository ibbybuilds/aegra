...
from ..data.career_advisors import get_all_advisors
from ..models import User
from ..services.advisor_cache import get_cached_advisor, invalidate_user_cache
...
async def get_my_career_advisor(
    ...
    from ..data.career_advisors import get_default_advisor
