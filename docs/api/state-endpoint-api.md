...
The context type system was recently refactored from **8 types to 5 types** for simplicity and clarity.

For detailed history of what changed and migration guidance, see [Context Type Refactoring History](../architecture/context-type-refactoring-history.md).
...
- [AVA Prompt Architecture](../architecture/ava-prompt-architecture.md) - Priority system and workflow optimization
