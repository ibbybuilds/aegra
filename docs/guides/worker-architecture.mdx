...
<a href="https://mermaid.live/view#pako:eNqdU01PwkAQ_SuT5aIRChQE4WAioqCSUCzGg_WwbQdpKK3ubv0C_rvb7lIaAxe6h87He5N5b7Mr4sU-ki6QWRh_eXPKBEz7TgTyuw4DjMSLQ1QAJ3b_AaownE6tU4e8KtCVdScRt5QLGeXVR_QDLuvZH-5jFyYJJpj3n2O2QCYBKsjr1kDWrJiLN4b2ZLSrJ66duPlAmVZlnrd7LFbjbPtGJ1mvqAMqlcu1Q--91RcQcl9nL9SlbkM3mD0UxLXM=" target="_blank" rel="noopener">View fullscreen ↗</a>
...
flowchart TD
    ...
    Client -->|"1. POST /runs"| API
    API -->|"2. persist + enqueue"| Redis
    Redis -->|"3. BLPOP"| Worker
    Worker -->|"4. lease + execute + finalize"| PG
    Worker -->|"5. PUBLISH events"| PubSub
    PubSub -->|"6. subscribe"| Broker
    Broker -->|"7. SSE stream"| Client
...
<a href="https://mermaid.live/view#pako:eNqdk11PwjAUhv_KSbnRBMIGonExJmwmRLOYAd45L7r18OFGS9ouSAj_3W4wGCpg6C7W8_G05z0nXZFYMCQOkFEqFvGESg1vTyEHs3z3PSS-oAxcmlIeowzJR8g3QZVFY0nnE3jmSudBZZKhSIDt6hpPGYVuGPKrNiyETFAq-ALbgk8RqesDxK0i7r8Qr4q8nkWQs18SXBonxp8rGJoOINt5Dm4aIJvmOcXfXPQiIuhnmCE0Icii5jCLzM7LC0kPwKBnqEAoPZY47PsGHWRcmVwfqcJ8400wTuZiyrX6q1LfhUbj0fSwarkHllfm7uYBD0VWqaQUrZepmQaMpmnq1Gxq0xbWlZYiQadmjdo3t1Y9FqmQTg2t_Kti7mWYdxm2V1LgWlKu5mY8XP88YmM2GFVmfJIunQ50jp9bzG9bUovZUaWk2Grft6LjaNArpUSG3HOtO4onG7edwkn6vApSBzJDOaNTZp7siugJzorHy6hMyHr9DXZ_Lls=" target="_blank" rel="noopener">View fullscreen ↗</a>
...
flowchart TD
    ...
    subgraph Backends["Shared Backends"]
        Redis["Redis\nJob Queue / Pub/Sub / Cancel"]
        PG["PostgreSQL\nRuns / Leases / Checkpoints"]
    end
